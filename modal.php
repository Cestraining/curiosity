            ...
            <div class="forms">
                <div id="form1">
                    ...
                    <form id="f1reset" action="" autocomplete="off">
                        ...
                        <input id="stupass" type="text" id="pass" name="pass" placeholder="password" required><br>
                    </form>
                ...
                <form id="f2reset" action="" autocomplete="off">
                        <label for="email"><img class="icons" src="images/envelope.svg"></img> Email</label><br>
                        <input id="stuemailC" type="text" id="email" name="email" placeholder="Email" required><br>
                        <label for="pass"><img class="icons" src="images/key.svg"></img>Password</label><br>
                        <input id="stupassC" type="text" id="pass" name="pass" placeholder="password" required><br>
                </form>
